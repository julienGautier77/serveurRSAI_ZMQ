...
class MAINMOTOR(QWidget):
    ...
    def SETUP(self):
        ...
        self.P3M = TILTMOTORGUI('10.0.6.31',7,'10.0.6.31',8,nomWin='P3 mirror  ',nomTilt='P1 M')
        self.P3Mir_But = QPushButton('P3 Mir')
        self.P3Mir_But.clicked.connect(lambda:self.open_widget(self.P3M))

        self.P1OPA = TILTMOTORGUI(IPVert='10.0.6.31',NoMotorVert=9,IPLat='10.0.6.31',NoMotorLat=10,nomWin='P1 Spherique  ',nomTilt='P1 Sphe')
        ...
        ## Focal Spot 
        self.motFS = ONEMOTORGUI(IpAdress="10.0.6.31", NoMotor = 14, showRef=False, unit=1,jogValue=100,parent=self)
